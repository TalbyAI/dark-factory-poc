...
function getBrowserMediaMatcher(): ((query: string) => MediaQueryList) | undefined {
	if (typeof window === 'undefined') return undefined
...
export function getStoredTheme(storage: Storage | undefined = getBrowserStorage()): Theme | null {
...
export function getPreferredTheme(
	matchMedia: ((query: string) => MediaQueryList) | undefined = getBrowserMediaMatcher(),
): Theme {
...
export function syncTheme(theme: Theme, options?: {
